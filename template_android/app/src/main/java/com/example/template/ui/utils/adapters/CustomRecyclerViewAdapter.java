package com.example.template.ui.utils.adapters;
...
import com.example.template.model.backend.ApiUtils;
...
import com.example.template.utils.PaginationScrollListener;
...
public class CustomRecyclerViewAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int RestApiListCategoriesType = 9;
    public static final int RestApiListItemsType = 10;
    ...
    public int getItemViewType(int position) {
        switch (mAdapterType) {
            case NotesType:
                return NotesType;
            case RestApiListCategoriesType:
                return RestApiListCategoriesType;
            case RestApiListItemsType:
                return RestApiListItemsType;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case RestApiListItemsType:
                return new RestApiListFrgItemsVH(parent.getContext(), RestApiListFrgItemsVH.getView(mContext, parent));
            case SqliteListCategoriesType:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            ...
            case RestApiListCategoriesType:
                ...
                break;
            case RestApiListItemsType:
                ((RestApiListFrgItemsVH) holder).bindData(getItem(position), position);
                break;
            case SqliteListCategoriesType:
